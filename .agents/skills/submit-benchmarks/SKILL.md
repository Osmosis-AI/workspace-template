...
- Model `api_key_secret` cannot reference the runner-reserved names `DAYTONA_API_KEY` or `DAYTONA_API_URL`. Those are Platform-managed sandbox plumbing; choose another Platform record name for model credentials.
