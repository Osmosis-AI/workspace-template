...
from multiply_harbor_strands_rollout.grader import MultiplyGrader
from multiply_harbor_strands_rollout.grader import multiply_grader_config
from multiply_harbor_strands_rollout.workflow import MultiplyWorkflow
from multiply_harbor_strands_rollout.workflow import multiply_workflow_config
...
def main() -> None:
    ...
    backend = HarborBackend(
        ...
        user_code_dir=ROLLOUT_DIR / "multiply_harbor_strands_rollout",
